...
namespace MultiThreading.Task3.MatrixMultiplier.Tests
{
    ...
    public class MultiplierTest
    {
        ...
        public void ParallelEfficiencyTest()
        {
            ...
            IMatrix resultRegularMatrix = new MatricesMultiplier().Multiply(firstMatrix, secondMatrix);

            Assert.AreEqual(resultParallelMatrix.ColCount, resultRegularMatrix.ColCount);
            Assert.AreEqual(resultParallelMatrix.RowCount, resultRegularMatrix.RowCount);
        }
